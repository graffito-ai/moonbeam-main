...
import {
    ...
    BankingItemResponse,
    CardLinkErrorType, CreateBankingItemInput,
    ...
    GetNotificationByTypeResponse, GetPlaidLinkingSessionByTokenInput,
    ...
    NotificationsErrorType, PlaidLinkingErrorType, PlaidLinkingSession, PlaidLinkingSessionResponse,
    PushDevice,
...
export class MoonbeamClient extends BaseAPIClient {
     ...
     */
    async getNotificationByType(getNotificationByTypeInput: GetNotificationByTypeInput): Promise<GetNotificationByTypeResponse> {
        // easily identifiable API endpoint information
     ...
     */
    async getPlaidLinkingSessionByToken(getPlaidLinkingSessionByTokenInput: GetPlaidLinkingSessionByTokenInput): Promise<PlaidLinkingSessionResponse> {
        // easily identifiable API endpoint information
        ...
        try {
             ...
             */
            return axios.post(`${moonbeamBaseURL}`, {
                query: getPlaidLinkingSessionByToken,
                variables: {
                ...
                if (responseData && responseData.getPlaidLinkingSessionByToken.errorMessage === null) {
                    ...
                    return {
                        data: responseData.getPlaidLinkingSessionByToken.data as PlaidLinkingSession
                    }
                } else {
                    return responseData ?
                        // return the error message and type, from the original AppSync call
     ...
     * Plaid linking session
     */
    async createPlaidLinkingSession(createPlaidLinkingSessionInput: CreatePlaidLinkingSessionInput): Promise<PlaidLinkingSessionResponse> {
        // easily identifiable API endpoint information
        ...
        try {
             ...
             */
            return axios.post(`${moonbeamBaseURL}`, {
                query: createPlaidLinkingSession,
                variables: {
                ...
                if (responseData && responseData.createPlaidLinkingSession.errorMessage === null) {
                    ...
                    return {
                        data: responseData.createPlaidLinkingSession.data as PlaidLinkingSession
                    }
                } else {
                    return responseData ?
                        // return the error message and type, from the original AppSync call
     ...
     * @protected
     */
    async getAllUsersIneligibleForReimbursements(): Promise<UserForNotificationReminderResponse> {
        // easily identifiable API endpoint information
        ...
        try {
            ...
            return axios.post(`${moonbeamBaseURL}`, {
                ...
                if (responseData && responseData.getAllUsersIneligibleForReimbursements.errorMessage === null) {
                    ...
                    return {
                        data: responseData.getAllUsersIneligibleForReimbursements.data as RetrieveUserDetailsForNotifications[]
                    }
                } else {
                    return responseData ?
                        // return the error message and type, from the original AppSync call
     ...
     * from Cognito.
     */
    async getEmailByUserId(userId: String): Promise<EmailFromCognitoResponse> {
        // easily identifiable API endpoint information
        ...
        try {
            ...
            if (userResults.length !== 0) {
                ...
                return {
                    errorType: NotificationsErrorType.NoneOrAbsent,
                    errorMessage: errorMessage
                };
            }
        } catch (err) {
     ...
     * Banking Item object
     */
    async createBankingItem(createBankingItemInput: CreateBankingItemInput): Promise<BankingItemResponse> {
        // easily identifiable API endpoint information
        ...
        try {
            ...
            return axios.post(`${moonbeamBaseURL}`, {
                ...
                if (responseData && responseData.createBankingItem.errorMessage === null && responseData.createBankingItem.data) {
                    ...
                    return {
                        data: responseData.createBankingItem.data as BankingItem
                    }
                } else {
                    return responseData ?
                        // return the error message and type, from the original AppSync call
                        ...
                        {
                            errorMessage: `Invalid response structure returned from ${endpointInfo} response!`,
                            errorType: BankingItemErrorType.ValidationError
                        }
                }
            }).catch(error => {
                if (error.response) {
     ...
     */
    async createDailyEarningsSummary(createDailyEarningsSummaryInput: CreateDailyEarningsSummaryInput): Promise<DailyEarningsSummaryResponse> {
        // easily identifiable API endpoint information
        ...
        try {
             ...
             */
            return axios.post(`${moonbeamBaseURL}`, {
                query: createDailyEarningsSummary,
                variables: {
                ...
                if (responseData && responseData.createDailyEarningsSummary.errorMessage === null) {
                    ...
                    return {
                        data: responseData.createDailyEarningsSummary.data as DailyEarningsSummary[]
                    }
                } else {
                    return responseData ?
                        // return the error message and type, from the original AppSync call
                        ...
                        {
                            errorMessage: `Invalid response structure returned from ${endpointInfo} response!`,
                            errorType: DailySummaryErrorType.ValidationError
                        }
                }
            }).catch(error => {
                if (error.response) {
     ...
     */
    async getAllDevices(): Promise<UserDevicesResponse> {
        // easily identifiable API endpoint information
        ...
        try {
            ...
            return axios.post(`${moonbeamBaseURL}`, {
                ...
                if (responseData && responseData.getAllDevices.errorMessage === null) {
                    ...
                    return {
                        data: responseData.getAllDevices.data as PushDevice[]
                    }
                } else {
                    return responseData ?
                        // return the error message and type, from the original AppSync call
