import {
    ...
    GetUserCardLinkingIdResponse, IneligibleTransaction,
...
export class OliveClient extends BaseAPIClient {
     ...
     * @protected
     */
    async getIneligibleBrandDetails(ineligibleTransaction: IneligibleTransaction): Promise<IneligibleTransactionResponse> {
        // easily identifiable API endpoint information
        ...
        try {
             ...
             * error for a better customer experience.
             */
            return axios.get(`${oliveBaseURL}/brands/${ineligibleTransaction.brandId}`, {
                headers: {
                    "Content-Type": "application/json",
                    "Olive-Key": olivePrivateKey
                },
