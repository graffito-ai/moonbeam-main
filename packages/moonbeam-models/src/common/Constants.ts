...
export namespace Constants {
    ...
    export namespace MoonbeamConstants {
        ...
        export const BANKING_ITEMS_TABLE: string = 'BANKING_ITEMS_TABLE';
        ...
        export const PHYSICAL_DEVICES_BY_STATE_GLOBAL_INDEX: string = 'PHYSICAL_DEVICES_BY_STATE_GLOBAL_INDEX';
        ...
        export const NOTIFICATIONS_TYPE_AND_TIME_GLOBAL_INDEX: string = 'NOTIFICATIONS_TYPE_AND_TIME_GLOBAL_INDEX';
        export const NOTIFICATION_REMINDER_PROCESSING_TOPIC_ARN: string = 'NOTIFICATION_REMINDER_PROCESSING_TOPIC_ARN';
        export const PLAID_LINK_PROCESSING_TOPIC_ARN: string = 'PLAID_LINK_PROCESSING_TOPIC_ARN';
        ...
        export const INELIGIBLE_TRANSACTIONS_PROCESSING_TOPIC_ARN: string = 'INELIGIBLE_TRANSACTIONS_PROCESSING_TOPIC_ARN';
        ...
        export const LOCATION_BASED_REMINDERS_PROCESSING_TOPIC_ARN: string = 'LOCATION_BASED_REMINDERS_PROCESSING_TOPIC_ARN';
        ...
        export const PLAID_LINK_TOKEN_LOCAL_INDEX: string = 'PLAID_LINK_TOKEN_LOCAL_INDEX';
        export const BANKING_ITEM_LINK_TOKEN_LOCAL_INDEX: string = 'BANKING_ITEM_LINK_TOKEN_LOCAL_INDEX';
        export const PLAID_LINK_TOKEN_GLOBAL_INDEX: string = `PLAID_LINK_TOKEN_GLOBAL_INDEX`;
        export const TRANSACTIONS_STATUS_GLOBAL_INDEX: string = 'TRANSACTIONS_STATUS_GLOBAL_INDEX';
        export const TRANSACTIONS_IN_RANGE_GLOBAL_INDEX: string = 'TRANSACTIONS_IN_RANGE_GLOBAL_INDEX';
    ...
    export namespace AWSPairConstants {
        ...
        export const EMAIL_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_AUTH_TOKEN = `EMAIL_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_AUTH_TOKEN`;
        export const EMAIL_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_TEMPLATE_ID = `EMAIL_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_TEMPLATE_ID`;
        export const PUSH_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_AUTH_TOKEN = `PUSH_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_AUTH_TOKEN`;
        export const PUSH_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_TEMPLATE_ID = `PUSH_SAN_ANTONIO_REFERRAL_TEMPLATE_1_REMINDER_TEMPLATE_ID`;

        export const EMAIL_ROUNDUPS_WAITLIST_TEMPLATE_1_REMINDER_AUTH_TOKEN = `EMAIL_ROUNDUPS_WAITLIST_TEMPLATE_1_REMINDER_AUTH_TOKEN`;
        export const EMAIL_ROUNDUPS_WAITLIST_TEMPLATE_1_REMINDER_TEMPLATE_ID = `EMAIL_ROUNDUPS_WAITLIST_TEMPLATE_1_REMINDER_TEMPLATE_ID`;

        export const EMAIL_REIMBURSEMENTS_REMINDER_AUTH_TOKEN = `EMAIL_REIMBURSEMENTS_REMINDER_AUTH_TOKEN`;
        export const EMAIL_REIMBURSEMENTS_REMINDER_TEMPLATE_ID = `EMAIL_REIMBURSEMENTS_REMINDER_TEMPLATE_ID`;
        export const PUSH_REIMBURSEMENTS_REMINDER_AUTH_TOKEN = `PUSH_REIMBURSEMENTS_REMINDER_AUTH_TOKEN`;
        export const PUSH_REIMBURSEMENTS_REMINDER_TEMPLATE_ID = `PUSH_REIMBURSEMENTS_REMINDER_TEMPLATE_ID`;

        export const PUSH_SPENDING_REMINDER_TEMPLATE_1_AUTH_TOKEN = `PUSH_SPENDING_REMINDER_TEMPLATE_1_AUTH_TOKEN`;
        export const PUSH_SPENDING_REMINDER_TEMPLATE_1_TEMPLATE_ID = `PUSH_SPENDING_REMINDER_TEMPLATE_1_TEMPLATE_ID`;
        ...
        export const PUSH_NEW_INELIGIBLE_TRANSACTION_AUTH_TOKEN = `PUSH_NEW_INELIGIBLE_TRANSACTION_AUTH_TOKEN`;
        export const PUSH_NEW_INELIGIBLE_TRANSACTION_TEMPLATE_ID = `PUSH_NEW_INELIGIBLE_TRANSACTION_TEMPLATE_ID`;

        export const PUSH_DAILY_EARNINGS_SUMMARY_AUTH_TOKEN = `PUSH_DAILY_EARNINGS_SUMMARY_AUTH_TOKEN`;
        export const PUSH_DAILY_EARNINGS_SUMMARY_TEMPLATE_ID = `PUSH_DAILY_EARNINGS_SUMMARY_TEMPLATE_ID`;
        export const EMAIL_DAILY_EARNINGS_SUMMARY_AUTH_TOKEN = `EMAIL_DAILY_EARNINGS_SUMMARY_AUTH_TOKEN`;
        export const EMAIL_DAILY_EARNINGS_SUMMARY_TEMPLATE_ID = `EMAIL_DAILY_EARNINGS_SUMMARY_TEMPLATE_ID`;
        ...
        export const PUSH_LOCATION_BASED_UPDATE_NOTIFICATION_AUTH_TOKEN = `PUSH_LOCATION_BASED_UPDATE_NOTIFICATION_AUTH_TOKEN`;
        export const PUSH_LOCATION_BASED_UPDATE_NOTIFICATION_TEMPLATE_ID = `PUSH_LOCATION_BASED_UPDATE_NOTIFICATION_TEMPLATE_ID`;
