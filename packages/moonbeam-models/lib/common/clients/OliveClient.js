...
class OliveClient extends BaseAPIClient_1.BaseAPIClient {
    ...
    async getOffers(getOffersInput) {
        ...
        try {
            ...
            requestURL += (getOffersInput.filterType === GraphqlExports_1.OfferFilter.Nearby || getOffersInput.filterType === GraphqlExports_1.OfferFilter.PremierNearby || getOffersInput.filterType === GraphqlExports_1.OfferFilter.CategorizedNearby)
