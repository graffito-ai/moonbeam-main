...
export declare namespace Constants {
    ...
    namespace MoonbeamConstants {
        ...
        const MILITARY_VERIFICATION_REPORTING_PROCESSING_TOPIC_ARN: string;
    ...
    namespace AWSPairConstants {
        ...
        const SPOUSE_FEATURE_REMINDER_AUTH_TOKEN = "SPOUSE_FEATURE_REMINDER_AUTH_TOKEN";
        const SPOUSE_FEATURE_REMINDER_TEMPLATE_ID = "SPOUSE_FEATURE_REMINDER_TEMPLATE_ID";
        const FEEDBACK_TEMPLATE_1_REMINDER_AUTH_TOKEN = "FEEDBACK_TEMPLATE_1_REMINDER_AUTH_TOKEN";
        const FEEDBACK_TEMPLATE_1_REMINDER_TEMPLATE_ID = "FEEDBACK_TEMPLATE_1_REMINDER_TEMPLATE_ID";
        const EMAIL_MULTIPLE_CARDS_FEATURE_REMINDER_AUTH_TOKEN = "EMAIL_MULTIPLE_CARDS_FEATURE_REMINDER_AUTH_TOKEN";
        const EMAIL_MULTIPLE_CARDS_FEATURE_REMINDER_TEMPLATE_ID = "EMAIL_MULTIPLE_CARDS_FEATURE_REMINDER_TEMPLATE_ID";
        const PUSH_MULTIPLE_CARDS_FEATURE_REMINDER_AUTH_TOKEN = "PUSH_MULTIPLE_CARDS_FEATURE_REMINDER_AUTH_TOKEN";
        const PUSH_MULTIPLE_CARDS_FEATURE_REMINDER_TEMPLATE_ID = "PUSH_MULTIPLE_CARDS_FEATURE_REMINDER_TEMPLATE_ID";
        const PUSH_REFERRAL_TEMPLATE_LAUNCH_AUTH_TOKEN = "PUSH_REFERRAL_TEMPLATE_LAUNCH_AUTH_TOKEN";
        const PUSH_REFERRAL_TEMPLATE_LAUNCH_TEMPLATE_ID = "PUSH_REFERRAL_TEMPLATE_LAUNCH_TEMPLATE_ID";
        const EMAIL_REFERRAL_TEMPLATE_LAUNCH_AUTH_TOKEN = "EMAIL_REFERRAL_TEMPLATE_LAUNCH_AUTH_TOKEN";
        const EMAIL_REFERRAL_TEMPLATE_LAUNCH_TEMPLATE_ID = "EMAIL_REFERRAL_TEMPLATE_LAUNCH_TEMPLATE_ID";
        const PUSH_REFERRAL_TEMPLATE_1_AUTH_TOKEN = "PUSH_REFERRAL_TEMPLATE_1_AUTH_TOKEN";
        const PUSH_REFERRAL_TEMPLATE_1_TEMPLATE_ID = "PUSH_REFERRAL_TEMPLATE_1_TEMPLATE_ID";
        const EMAIL_REFERRAL_TEMPLATE_1_AUTH_TOKEN = "EMAIL_REFERRAL_TEMPLATE_1_AUTH_TOKEN";
        const EMAIL_REFERRAL_TEMPLATE_1_TEMPLATE_ID = "EMAIL_REFERRAL_TEMPLATE_1_TEMPLATE_ID";
        const PUSH_VETERANS_DAY_TEMPLATE_1_AUTH_TOKEN = "PUSH_VETERANS_DAY_TEMPLATE_1_AUTH_TOKEN";
        const PUSH_VETERANS_DAY_TEMPLATE_1_TEMPLATE_ID = "PUSH_VETERANS_DAY_TEMPLATE_1_TEMPLATE_ID";
        const PUSH_VETERANS_DAY_TEMPLATE_2_AUTH_TOKEN = "PUSH_VETERANS_DAY_TEMPLATE_2_AUTH_TOKEN";
        const PUSH_VETERANS_DAY_TEMPLATE_2_TEMPLATE_ID = "PUSH_VETERANS_DAY_TEMPLATE_2_TEMPLATE_ID";
        const EMAIL_VETERANS_DAY_TEMPLATE_3_AUTH_TOKEN = "EMAIL_VETERANS_DAY_TEMPLATE_3_AUTH_TOKEN";
        const EMAIL_VETERANS_DAY_TEMPLATE_3_TEMPLATE_ID = "EMAIL_VETERANS_DAY_TEMPLATE_3_TEMPLATE_ID";
        const PUSH_VETERANS_DAY_TEMPLATE_3_AUTH_TOKEN = "PUSH_VETERANS_DAY_TEMPLATE_3_AUTH_TOKEN";
        const PUSH_VETERANS_DAY_TEMPLATE_3_TEMPLATE_ID = "PUSH_VETERANS_DAY_TEMPLATE_3_TEMPLATE_ID";
        ...
        const EMAIL_NEW_MAP_FEATURE_REMINDER_AUTH_TOKEN = "EMAIL_NEW_MAP_FEATURE_REMINDER_AUTH_TOKEN";
        const EMAIL_NEW_MAP_FEATURE_REMINDER_TEMPLATE_ID = "EMAIL_NEW_MAP_FEATURE_REMINDER_TEMPLATE_ID";
        const PUSH_NEW_MAP_FEATURE_REMINDER_AUTH_TOKEN = "PUSH_NEW_MAP_FEATURE_REMINDER_AUTH_TOKEN";
        const PUSH_NEW_MAP_FEATURE_REMINDER_TEMPLATE_ID = "PUSH_NEW_MAP_FEATURE_REMINDER_TEMPLATE_ID";
        ...
        const OLIVE_MOONBEAM_VETERANS_DAY_LOYALTY = "OLIVE-MOONBEAM-VETERANS-DAY-LOYALTY";
        const OLIVE_MOONBEAM_CLICK_LOYALTY = "OLIVE-MOONBEAM-CLICK-LOYALTY";
        const OLIVE_MOONBEAM_PREMIER_CLICK_LOYALTY = "OLIVE-MOONBEAM-PREMIER-CLICK-LOYALTY";
        const APP_UPGRADE_SECRET_NAME = "app-upgrade-secret-pair";
        const APP_UPGRADE_API_KEY = "APP-UPGRADE-API-KEY";
        const APP_UPGRADE_BASE_URL = "APP-UPGRADE-BASE-URL";
    }
}
