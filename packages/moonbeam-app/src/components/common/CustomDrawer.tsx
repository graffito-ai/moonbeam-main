...
export const CustomDrawer = (props: DrawerContentComponentProps & (RootStackParamList["MainDash"])) => {
    ...
    // state used to keep track of whether the drawer is ready or not
    const [isDrawerReady, setIsDrawerReady] = useState<boolean>(false);
     ...
     */
    useEffect(() => {
        if (props.currentUserInformation && props.currentUserInformation !== '{}' && props.currentUserInformation["name"]) {
            ...
            setCurrentUserName(props.currentUserInformation["name"]);
