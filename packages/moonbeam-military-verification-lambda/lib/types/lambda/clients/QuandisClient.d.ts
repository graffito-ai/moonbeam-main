import { MilitaryVerificationInformation, MilitaryVerificationStatusType } from "@moonbeam/moonbeam-models";
import { VerificationClient } from "./VerificationClient";
/**
 * Class used as the base/generic client for all Quandis verification calls.
 */
export declare class QuandisClient extends VerificationClient {
    /**
