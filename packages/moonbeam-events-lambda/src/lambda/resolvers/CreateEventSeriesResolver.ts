    ...
    try {
        ...
        if (preExistingEventSeries && preExistingEventSeries.Item) {
            ...
            return {
                ...
                errorType: EventsErrorType.DuplicateObjectFound
            }
        } else {
            ...
            if ((eventSeriesCreationResponse.errorMessage === undefined || eventSeriesCreationResponse.errorMessage === null) &&
                ...
                eventSeriesCreationResponse.data !== undefined && eventSeriesCreationResponse.data!.events !== undefined &&
                eventSeriesCreationResponse.data!.events.length !== 0) {
                // create the events array, obtained from the EventBrite call
                const eventsList: any[] = [];
                eventSeriesCreationResponse.data!.events.forEach(event => {
                    if (event !== null) {
                        eventsList.push({
                            M: {
                                id: {
                ...
                await dynamoDbClient.send(new PutItemCommand({
                    ...
                    Item: {
                        ...
                        id: {
                            S: eventSeriesCreationResponse.data!.id
                        },
                        externalOrgID: {
                            S: eventSeriesCreationResponse.data!.externalOrgID
                        },
                        externalSeriesID: {
                            S: createEventSeriesInput.externalSeriesID
                        },
                        description: {
                            S: eventSeriesCreationResponse.data!.description
                        },
                        status: {
                            S: eventSeriesCreationResponse.data!.status
                        },
                        createdAt: {
                        ...
                        seriesLogoUrlBg: {
                            S: eventSeriesCreationResponse.data!.seriesLogoUrlBg
                        },
                        seriesLogoUrlSm: {
                            S: eventSeriesCreationResponse.data!.seriesLogoUrlSm
                        },
                        events: {
                            L: eventsList
                        }
                ...
                return {
                    data: eventSeriesCreationResponse.data
                }
            } else {
